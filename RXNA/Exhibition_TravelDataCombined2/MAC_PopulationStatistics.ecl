...
+    #IF( #TEXT(Input_Share_With)='' )
    ...
    #END
+    #IF( #TEXT(Input_Booker_First_Name)='' )
      '' 
    #ELSE
        IF( le.Input_Booker_First_Name = (TYPEOF(le.Input_Booker_First_Name))'','',':Booker_First_Name')
    #END
+    #IF( #TEXT(Input_Booker_Last_Name)='' )
      '' 
    #ELSE
        IF( le.Input_Booker_Last_Name = (TYPEOF(le.Input_Booker_Last_Name))'','',':Booker_Last_Name')
    #END
